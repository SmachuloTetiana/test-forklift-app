    ...
    <div className="row AboutUs">
      <div className="col-lg-7 col-12">
        ...
        <p>
          ...
          Nissan, Mitsubishi, TCM, Linde, Manitou, Caterpillar, Kalmar, Pramac.
        </p>
        <p>
          Mikro-F Ltd. is well known as manufacturer of forklift trucks (diesel
          and gasoline, capacity up to 16 tons).
        </p>
        <p>
          We have a wide range of spare parts for all models of equipment known
          brands from Japan, Europe and USA as well as components (tyres for
          forklift trucks, batteries, chargers, spare parts for forklifts)
